    ...
    <div class="container-fluid mt-5">
        <div class="row mb-2 align-items-center">
            ...
            <div class=" p-3 " style="text-align: right;">
                <a href="#" class="btn btn-outline-primary rounded-0">See All Performer </a>
            </div>
        </div>
        <hr>
        <div class="row">
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="card rounded-0 position-relative">
                                    <div class="card-body">
                                        ...
                                        <p>Examiner : Satyajit </p>
                                        <p>Subject : <span class="badge text-bg-secondary">Bangla</span> <span class="badge text-bg-secondary">English</span> </p>
                                    </div>
