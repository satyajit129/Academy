            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="exam-details">
                        <p><span>প্রশ্নের সংখ্যা</span><span class="dotted-line"></span><span>{{ $previous_job_exam->questions->count() }} প্রশ্ন</span></p>
                        <p><span>মোট নম্বর</span><span class="dotted-line"></span><span>{{ $previous_job_exam->questions->count() }} নম্বর</span></p>
                        
                        <p><span>নেগেটিভ মার্কস</span><span class="dotted-line"></span><span>{{ $previous_job_exam->negative_mark }} নম্বর</span></p>
                        <p>
                            <span>পরীক্ষার সময়কাল</span>
                            <span class="dotted-line"></span>
                            <span id="exam-timer">{{ $previous_job_exam->duration }}:00 </span> &nbsp; মিনিট
                        </p>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
      ...
      var duration = {{ $previous_job_exam->duration }};
